...
import "../utiles/estacionamientoB.css";

const EstacionamientoB = () => {
  ...
  return (
    <div className="estacionamiento">
      ...
      <h1>Estacionamiento De Bicicletas</h1>
      <div className="grid">
        <div className="contenido5">
          <p>¡Ten previsto donde te estacionarás!</p>
          <p>Solo llega y acomoda tu Bicicleta.</p>
        </div>
...
export default EstacionamientoB;
